...
export function collisionMap(map, character, typeCollide) {
...
export function collisionMap2(map, character) {
    for (let i = 0; i < map.length; i++) {
        if (collision(character, {
...
export function collisionMap3(map, character) {
    for (let i = 0; i < map.length; i++) {
        if (collision(character, {
...
export function Movement(PlayerStatus, keyPressed, deltaTime, nextFrameAnimation, tilemapData, npcData) {
    let hasMoved = false;
...
export function npcEncounter(player, npc) {
